...
| OPN-03 | Employer (col 4): two rows list exactly "The Address" and were excluded as own staff. Confirm or reverse. **Answered 15 Sep 2026:** confirmed. "The Address" as employer means The Address Investments; both rows stay excluded. | No change: the stored exclusions stand. | P2 migration sign-off |
