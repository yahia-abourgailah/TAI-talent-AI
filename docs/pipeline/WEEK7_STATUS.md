...
- `core.criteria_borderline` (migration 0015) holds one signed rule per criteria version, never
...
- Integration: 254 pass, 10 of them new, on a freshly migrated database (0001 → 0015).
